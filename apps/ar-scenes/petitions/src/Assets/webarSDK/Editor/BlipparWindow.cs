...
public class BlipparWindow : EditorWindow
{
    ...
    #region PrivateField
    private string sdkPath = "sdk/blippar-webar-sdk-v1.6.1/webar-sdk/webar-sdk-v1.6.1.min.js";
    private string defaultLicense = "xxxx-1111-2222-3333-yyyy";    private string defaultDomainName = "https://xxxx.yyy";    private string defaultPath = "sdk/blippar-webar-sdk-v1.6.1/webar-sdk/webar-sdk-v1.6.1.min.js";
    ...
    private void OnGUI()
    {
        ...
        GUILayout.Label("v_1.6.1.0", EditorStyles.centeredGreyMiniLabel);
