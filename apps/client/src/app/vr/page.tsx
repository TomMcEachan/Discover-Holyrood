                    ...
                    <div className="col-span-3 text-base-100 text-xl">
                        <ol type="1" className="list-decimal">
                            <li className="mx-8 my-4">
                                Click on the video to start the tour. This will
                                start a YouTube playlist which will play each
                                stop of the tour one by one.
                            </li>
                            <li className="mx-8 my-4">
                            ...
                            <li className="mx-8 my-4">
                                Click on the VR icon to view the video in VR.
                            </li>
                            <li className="mx-8 my-4">
                                You can go full screen by clicking on the full
                                screen icon. This will allow you to fully
                                immerse yourself in the tour if you are using a
                                headset device.
                            </li>
                        </ol>
                    </div>
